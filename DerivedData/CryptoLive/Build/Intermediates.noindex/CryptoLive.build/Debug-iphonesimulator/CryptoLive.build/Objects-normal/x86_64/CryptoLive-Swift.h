...
SWIFT_CLASS("_TtC10CryptoLive11AppDelegate")
...
@property (nonatomic, weak) IBOutlet LTMorphingLabel * _Null_unspecified tradePrice;
...
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified segmentDataControl;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified last24hChangeLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified totalSupplyLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified marketCapLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified priceBTCLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified priceUSDLabel;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified currencySymbolLabel;
@property (nonatomic, strong) IBOutlet CandleStickChartView * _Null_unspecified candleStickChart;
- (void)viewDidLoad;
- (IBAction)onPressBack:(UIButton * _Nonnull)sender;
- (void)didReceiveMemoryWarning;
- (IBAction)onDataSegmentChange:(id _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(CryptoLive))
